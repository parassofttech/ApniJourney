...
<section className="relative max-w-6xl mx-auto md:px-6 py-16 selection:bg-sky-500 selection:text-white">
  ...
  <div className="text-center mb-16">
    ...
    <h2 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900">
      Budget Breakdown for Pachmarhi
    </h2>
    <p className="text-gray-500 mt-3 text-lg max-w-xl mx-auto font-medium leading-relaxed">
      Escape to the serene hill station of Satpura, where misty valleys and cascading waterfalls await.
    </p>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
    ...
    <div className="group bg-white/70 backdrop-blur-xl border border-gray-200 hover:border-sky-400/60 shadow-md hover:shadow-xl hover:shadow-sky-500/5 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1.5 mb-6 font-medium leading-relaxed">
          Ideal for trekkers utilizing local homestays, public transport, and exploring trails on foot.
        </p>
        ...
        <div className="space-y-3 pt-4 border-t border-gray-100">
          ...
          <div className="flex items-center justify-between bg-gray-50/50 p-2.5 rounded-xl border border-gray-100">
            <span className="text-gray-500 text-xs font-bold uppercase tracking-wider pl-1">🚶 Trek</span>
      ...
      <div className="mt-8 pt-5 border-t border-dashed border-gray-200">
        ...
        <div className="text-2xl font-black text-sky-600 tracking-tight">
          ₹1,300 – ₹2,500 <span className="text-xs font-bold text-gray-400">/ day</span>
        </div>
      </div>
    </div>
    ...
    <div className="group bg-white border-2 border-sky-500 hover:border-sky-400 shadow-xl hover:shadow-2xl hover:shadow-sky-500/10 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1 relative ring-8 ring-sky-500/5">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1.5 mb-6 font-medium leading-relaxed">
          Perfect for comfortable hotels, guided jeep safaris, and cafe hopping in the misty hills.
        </p>
        ...
        <div className="space-y-3 pt-4 border-t border-gray-100">
          ...
          <div className="flex items-center justify-between bg-gray-50/50 p-2.5 rounded-xl border border-gray-100">
            <span className="text-gray-500 text-xs font-bold uppercase tracking-wider pl-1">🍽️ Food</span>
            <span className="text-gray-900 font-extrabold text-sm">₹1.2k – ₹2k</span>
          </div>
          <div className="flex items-center justify-between bg-gray-50/50 p-2.5 rounded-xl border border-gray-100">
      ...
      <div className="mt-8 pt-5 border-t border-dashed border-gray-200">
        <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Estimated Velocity</div>
        <div className="text-2xl font-black text-sky-600 tracking-tight">
          ₹5,200 – ₹10,000 <span className="text-xs font-bold text-gray-400">/ day</span>
        </div>
      </div>
    </div>
    ...
    <div className="group bg-white/70 backdrop-blur-xl border border-gray-200 hover:border-indigo-400/60 shadow-md hover:shadow-xl hover:shadow-indigo-500/5 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1.5 mb-6 font-medium leading-relaxed">
          Luxury mountain resorts, private vehicle hire, and curated nature excursions.
        </p>
      ...
      <div className="mt-8 pt-5 border-t border-dashed border-gray-200">
        ...
        <div className="text-2xl font-black text-indigo-600 tracking-tight">
          ₹16k – ₹32k+ <span className="text-xs font-bold text-gray-400">/ day</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="mt-14 text-center">
    <div className="inline-flex items-center gap-3.5 bg-gradient-to-r from-sky-500/10 via-indigo-500/5 to-transparent border border-sky-500/20 backdrop-blur-md px-6 py-4 rounded-2xl text-left max-w-2xl mx-auto shadow-sm">
      ...
      <p className="text-sky-950 font-semibold text-sm md:text-[15px] leading-relaxed">
        <strong className="text-sky-800 font-black">Pro Tip:</strong> Visit Dhoopgarh at sunset—it is the highest point in the Satpura range and offers breathtaking panoramic views of the entire valley.
      </p>
    </div>
  </div>
</section>
...
<section className="relative max-w-6xl mx-auto md:px-6 py-16 selection:bg-rose-500 selection:text-white">
  ...
  <div className="text-center mb-14">
    ...
    <p className="text-gray-500 mt-3 text-lg max-w-xl mx-auto font-medium">
      Bring home organic honey, herbal products, and locally made bamboo crafts from the heart of the forest.
    </p>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
    <div className="group md:col-span-2 bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-rose-300 shadow-lg hover:shadow-xl hover:shadow-rose-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
      <div>
        ...
        <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
          Pachmarhi is famous for its <span className="font-semibold text-gray-900">pure, wild forest honey</span> collected by local tribal communities.
        </p>
      </div>
    ...
    <div className="group bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-amber-300 shadow-lg hover:shadow-xl hover:shadow-amber-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
      <div>
        ...
        <h3 className="text-2xl font-extrabold text-gray-900 group-hover:border-amber-700 transition-colors duration-200">
          Bamboo Crafts
        </h3>
        <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
          Discover beautiful <span className="font-semibold text-gray-900">hand-woven bamboo baskets and decorative items</span> made by local artisans.
        </p>
      </div>
    ...
    <div className="group bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-teal-300 shadow-lg hover:shadow-xl hover:shadow-teal-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
      <div>
        ...
        <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
          Buy <span className="font-semibold text-gray-900">Ayurvedic herbal soaps, oils, and teas</span> produced from forest-sourced ingredients.
        </p>
      </div>
    ...
    <div className="group md:col-span-2 bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-indigo-300 shadow-lg hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
      <div>
        ...
        <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
          Explore local <span className="font-semibold text-gray-900">hand-loomed fabrics and garments</span> that showcase the authentic designs of Satpura tribes.
        </p>
      </div>
    ...
    <div className="group bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-orange-300 shadow-lg hover:shadow-xl hover:shadow-orange-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
      <div>
        ...
        <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
          Find <span className="font-semibold text-gray-900">locally made woolen shawls and sweaters</span>, perfect for the pleasant mountain evenings.
        </p>
      </div>
  ...
  <div className="mt-12 text-center">
    <div className="inline-flex items-center gap-3 bg-gradient-to-r from-rose-500/10 via-sky-500/5 to-transparent border border-rose-100/70 backdrop-blur-md px-6 py-4 rounded-2xl text-left max-w-2xl mx-auto shadow-sm">
      ...
      <p className="text-rose-950 font-medium text-sm md:text-base leading-relaxed">
        <strong className="text-rose-900 font-bold">Shopping Tip:</strong> Visit the local 'Weekly Haat' if your trip aligns with it; you'll find the most authentic tribal crafts at much better prices than the tourist-centric main market.
      </p>
    </div>
  </div>
</section>
