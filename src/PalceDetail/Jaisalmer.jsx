        ...
        <div className="p-8">
          ...
          <section className="relative max-w-6xl mx-auto md:px-6 py-16 selection:bg-amber-500 selection:text-white">
            ...
            <div className="text-center mb-16">
              <span className="inline-flex items-center gap-1.5 bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 backdrop-blur-md">
                🏜️ Golden City Planner
              </span>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900">
                Budget Breakdown for Jaisalmer
              </h2>
              <p className="text-gray-500 mt-3 text-lg max-w-xl mx-auto font-medium leading-relaxed">
                Analyze daily cost structures to experience the magic of the Thar Desert, golden sandstone forts, and royal heritage.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="group bg-white/70 backdrop-blur-xl border border-gray-200 hover:border-amber-400/60 shadow-md hover:shadow-xl hover:shadow-amber-500/5 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1">
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1.5 mb-6 font-medium leading-relaxed">
                    Ideal for explorers focused on haveli-hopping and shared-camp desert experiences.
                  </p>
                  ...
                  <div className="space-y-3 pt-4 border-t border-gray-100">
                    ...
                    <div className="flex items-center justify-between bg-gray-50/50 p-2.5 rounded-xl border border-gray-100">
                      <span className="text-gray-500 text-xs font-bold uppercase tracking-wider pl-1">🏜️ Camel</span>
              ...
              <div className="group bg-white border-2 border-amber-500 hover:border-amber-400 shadow-xl hover:shadow-2xl hover:shadow-amber-500/10 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1 relative ring-8 ring-amber-500/5">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1.5 mb-6 font-medium leading-relaxed">
                    Perfect for heritage haveli stays, private jeep safaris, and authentic cultural evenings.
                  </p>
                  ...
                  <div className="space-y-3 pt-4 border-t border-gray-100">
                    ...
                    <div className="flex items-center justify-between bg-gray-50/50 p-2.5 rounded-xl border border-gray-100">
                      <span className="text-gray-500 text-xs font-bold uppercase tracking-wider pl-1">🚙 Jeep</span>
                ...
                <div className="mt-8 pt-5 border-t border-dashed border-gray-200">
                  <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Estimated Velocity</div>
                  <div className="text-2xl font-black text-amber-600 tracking-tight">
                    ₹6,500 – ₹14k <span className="text-xs font-bold text-gray-400">/ day</span>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-white/70 backdrop-blur-xl border border-gray-200 hover:border-orange-400/60 shadow-md hover:shadow-xl hover:shadow-orange-500/5 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1">
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1.5 mb-6 font-medium leading-relaxed">
                    Premium tent resorts, private luxury tours, and fine-dining under the starlit desert sky.
                  </p>
                ...
                <div className="mt-8 pt-5 border-t border-dashed border-gray-200">
                  ...
                  <div className="text-2xl font-black text-orange-600 tracking-tight">
                    ₹22k – ₹55k+ <span className="text-xs font-bold text-gray-400">/ day</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-14 text-center">
              <div className="inline-flex items-center gap-3.5 bg-gradient-to-r from-amber-500/10 via-orange-500/5 to-transparent border border-amber-500/20 backdrop-blur-md px-6 py-4 rounded-2xl text-left max-w-2xl mx-auto shadow-sm">
                ...
                <p className="text-amber-950 font-semibold text-sm md:text-[15px] leading-relaxed">
                  <strong className="text-amber-800 font-black">Pro Tip:</strong> Desert nights can get chilly! If you're visiting between November and February, pack layers, and always book your camel safari through registered operators to ensure a safe experience.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="relative max-w-6xl mx-auto md:px-6 py-16 selection:bg-teal-500 selection:text-white">
            ...
            <div className="text-center mb-14">
              ...
              <p className="text-gray-500 mt-3 text-lg max-w-xl mx-auto font-medium">
                From vibrant mirror-work textiles and block prints to intricate brassware, Jaisalmer is a shopper’s desert oasis.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
              <div className="group md:col-span-2 bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-teal-300 shadow-lg hover:shadow-xl hover:shadow-teal-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
                    The central shopping hub for vibrant <span className="font-semibold text-gray-900">mirror-work wall hangings, embroidered fabrics, and traditional leather goods</span>.
                  </p>
                </div>
              ...
              <div className="group bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-amber-300 shadow-lg hover:shadow-xl hover:shadow-amber-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
                    Discover unique <span className="font-semibold text-gray-900">Rajasthani block-printed sarees and fabrics</span> that capture the essence of desert colors.
                  </p>
                </div>
                <div className="mt-6 text-xs font-bold text-amber-600 tracking-wider uppercase">
                  Artisan Textiles
              ...
              <div className="group bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-rose-300 shadow-lg hover:shadow-xl hover:shadow-rose-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
                    Explore exquisite <span className="font-semibold text-gray-900">brass artifacts and antique replicas</span>, a testament to Jaisalmer's historic trade legacy.
                  </p>
                </div>
              ...
              <div className="group md:col-span-2 bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-purple-300 shadow-lg hover:shadow-xl hover:shadow-purple-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
                    Ideal for hunting down <span className="font-semibold text-gray-900">high-quality camel leather bags, journals, and traditional footwear (Juttis)</span> crafted by local artisans.
                  </p>
                </div>
              ...
              <div className="group bg-white/60 backdrop-blur-xl border border-gray-200/60 hover:border-emerald-300 shadow-lg hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-1">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed text-[15px] mt-3">
                    Discover unique <span className="font-semibold text-gray-900">tribal-style silver jewelry</span>, often adorned with colorful semi-precious stones.
                  </p>
                </div>
            ...
            <div className="mt-12 text-center">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-teal-500/10 via-amber-500/5 to-transparent border border-teal-100/70 backdrop-blur-md px-6 py-4 rounded-2xl text-left max-w-2xl mx-auto shadow-sm">
                ...
                <p className="text-teal-950 font-medium text-sm md:text-base leading-relaxed">
                  <strong className="text-teal-900 font-bold">Shopping Tip:</strong> Haggling is common in local bazaars! Stay polite but firm to get the best price for your artisan treasures.
                </p>
              </div>
            </div>
          </section>
