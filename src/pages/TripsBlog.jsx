...
const TripsBlog = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* HERO SECTION */}
      <section
        className="relative h-[40vh] md:h-[70vh] flex items-center justify-center bg-cover bg-center"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-5">
          ...
          <p className="mt-5 text-lg md:text-xl text-gray-200">
            Discover journeys shared by travelers around the world
          </p>


          <button onClick={() => navigate("/destinations")} className="mt-8 px-8 py-3 bg-white text-black rounded-full font-semibold hover:scale-105 transition">
            Start Exploring
          </button>
                ...
                <div className="px-4 pt-3.5 flex items-center justify-between">
                  <div className="flex gap-4">
                    ...
                    >
                      <Heart
                        size={22}
                        className={`transition-transform duration-150 active:scale-95 ${trip.likes?.includes(currentUser?._id || currentUser?.id)
                      ...
                      <span
                        className={`text-xs font-bold ${trip.likes?.includes(currentUser?._id || currentUser?.id)
                          ? "text-rose-600"
                          : "text-gray-600"
                          }`}
                      >
